...
class ParamInfo:
    def __init__(self, desc: str, val: int):   
        self.desc: str = desc
        self.val: int = val
...
PARAM_TABLE: dict[Params, ParamInfo] = {
    ...
    Params.DDC1_SFOUT:          ParamInfo("SFout (Msps)-0", 1),
    Params.DDC2_FMIX:           ParamInfo("SFout (Msps)-1", 1),
    Params.DDC2_SFOUT:          ParamInfo("SFout (Msps)-2", 1),
    Params.LP500MHZ_EN:         ParamInfo("Select Path-500MHz LP", 1),
