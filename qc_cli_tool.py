...
instanceCmdStream: str = "" #TODO get command stream from cli input
...
instanceDataStream: str = "" #TODO get command stream from cli input
...
def updateall():
    ...
    try:
        ...
        if instanceDataStream != "" #TODO get command stream from cli input
            ...
            #update stream name
            instanceDataStream = "" #TODO get command stream from cli input
        ...
        if instanceCmdStream != "" #TODO get command stream from cli input

            instanceCmdStream = "" #TODO get command stream from cli input
